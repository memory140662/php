...
INSERT INTO `good` (`id`, `user`, `news`) VALUES
(1, '1', 1),
(2, '1', 2),
(3, '1', 3),
(5, 'admin', 3);
...
(1, '問題一：你最常做什麼運動來促進健康體能呢?', 7, 0),
(2, '健走或爬樓梯、慢跑等較不受時間、場地限制的運動。', 3, 1),
(3, '仰臥起坐、抬腿及伏地挺身、伸展操、瑜珈等室內運動。', 1, 1),
(4, '球類運動、游泳、跳舞、騎腳踏車等加強心肺功能的運動。', 1, 1),
(5, '舉重鍛鍊、彈力帶、啞鈴等運用輔助器材鍛鍊肌耐力的運動。', 2, 1),
